...
import com.moogu.dcs.server.utils.DcsExceptionUtils;
import com.moogu.dcs.server.utils.DcsHttpRequestThreadLocal;
import com.moogu.dcs.server.utils.DcsUserThreadLocal;
...
public abstract class AbstractGwtServlet extends RemoteServiceServlet {
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        this.applicationContext = (ApplicationContext) servletConfig.getServletContext().getAttribute(
                        DcsServletContextListener.APP_CONTEXT_NAME);
    ...
    public String processCall(String payload) throws SerializationException {
        ...
        DcsUserThreadLocal.setUser(this.getUser());
        InvokeResponse invokeResponse;

        // Commit or roll-back transaction
        try {
            DcsHttpRequestThreadLocal.set(this.getThreadLocalRequest());
            ...
            DcsUserThreadLocal.cleanUser();
            DcsHttpRequestThreadLocal.clean();
        }
    ...
    protected InvokeResponse invokeAndEncodeResponse(Object target,
        ...
        try {
            ...
            if (cause instanceof RuntimeException) {
                ...
                returnedException = DcsExceptionUtils.toSharedException(cause);
                ...
                returnedException = DcsExceptionUtils.toSharedException(ite.getTargetException());
            } else if (cause != null) {
                AbstractGwtServlet.logger.error("Error while calling server method", cause);
                returnedException = DcsExceptionUtils.toSharedException(cause);
            } else {
                AbstractGwtServlet.logger.error("Error while calling server method", e);
                returnedException = DcsExceptionUtils.toSharedException(e);
            }
