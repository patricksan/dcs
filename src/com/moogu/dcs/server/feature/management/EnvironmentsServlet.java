...
public class EnvironmentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("Using getProperty = " + System.getProperty(DcsUtils.SYSTEM_VARIABLE_ENVIRONMENT) + "<br/>");
        out.println("Using getEnv = " + System.getenv(DcsUtils.SYSTEM_VARIABLE_ENVIRONMENT) + "<br/>");
